document.addEventListener('DOMContentLoaded', function() {
    ...
    style.innerHTML = `
      ...
      #popup-container { position: relative; width: 90%; max-width: 860px; border-radius: 10px; box-shadow: 0 10px 30px rgba(0,0,0,0.5); transform: translateY(20px); transition: transform 0.4s ease; }
      ...
      #popup-btn { position: absolute; bottom: 12%; left: 50%; transform: translateX(15%); background-color: #1a3a6b; color: #ffffff; text-decoration: none; padding: 12px 28px; border-radius: 50px; font-family: Arial, sans-serif; font-size: 18px; font-weight: bold; z-index: 10; box-shadow: 0 4px 10px rgba(26, 58, 107, 0.4); transition: all 0.2s; white-space: nowrap; }
      #popup-btn:hover { background-color: #122a52; transform: translateX(15%) scale(1.04); color: #ffffff; }
