		...
		>
			<div className="grid grid-cols-1 md:grid-cols-12">
				<motion.div
					...
					className="col-span-8 place-self-center text-center sm:text-left justify-self-start pr-6"
				>
					<div className="col-span-7 place-self-center text-center sm:text-left w-full">
						...
						<div className="flex flex-col sm:flex-row items-center md:justify-items-center md:mt-8 gap-6 sm:gap-10">
							<a href="#contact">
								<ShineBorder
									href="/#contact"
									className="w-auto text-center text-2xl font-bold bg-black bg-opacity-100 capitalize transition-all duration-300 ease-in-out cursor-none hover:bg-opacity-50 hover:text-white"
								>
									Contactez-moi
								</ShineBorder>
							</a>
							...
							>
								<ShineBorder className="w-auto text-center text-2xl bg-black bg-opacity-100 font-bold capitalize transition-all duration-300 ease-in-out cursor-none hover:bg-opacity-50 hover:text-white">
									Téléchargez CV
								</ShineBorder>
							</a>
						</div>
				...
				>
					<div className="col-span-4 place-self-center mt-10 lg:-mt-8">
						<div className="mask mask-hexagon-2 bg-gradient-to-br from-premiere-800 via-intermediaire-500 to-secondaire-500 w-60 h-60 sm:w-44 sm:h-44 md:w-50 md:h-50 lg:w-64 lg:h-64 xl:w-80 xl:h-80 relative">
							<Image
