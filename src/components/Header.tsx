    ...
    return (
        <>
            <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between w-full h-16 px-8 bg-white/90 dark:bg-black/90 backdrop-blur-sm shadow-md">
                ...
                >
                    <span className="span-animation">Pierre</span>
                </Link>
                ...
                <button
                    type="button"
                    className="md:hidden inline-flex items-center justify-center w-10 h-10 rounded-md border border-foreground/20 text-foreground/70 hover:text-foreground hover:border-foreground/40 transition"
            ...
            {isMenuOpen && (
                <div
                    id="mobile-menu"
                    className="fixed inset-0 z-40 bg-white/95 dark:bg-black/95 backdrop-blur-sm md:hidden"
                >
                    <div className="flex h-full flex-col items-center justify-center gap-8 text-lg">
                        {navLinks.map((link) => (
                            <Link
                                key={link.href}
                                href={link.href}
